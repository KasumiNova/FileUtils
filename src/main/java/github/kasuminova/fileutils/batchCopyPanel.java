...
import static github.kasuminova.fileutils.CopyFile.copyFile;
import static github.kasuminova.fileutils.CopyFile.multiThreadedCopyFile;
import static github.kasuminova.fileutils.Main.copyToDirPath;
...
public class batchCopyPanel {
    ...
    public JPanel createPanel(JFrame fileUtils) {
        ...
        //文件夹列表
        String[] copyToDirPathArr = copyToDirPath.toArray(new String[copyToDirPath.size()]);
        ...
        start1.addActionListener(e -> {
            ...
            if (new File("./" + mainDirTmp).exists()) {
                ...
                if (useMultiThread.isSelected()) {
                    multiThreadedCopyFile(mainDirTmp, copyToDirPath, fileUtils, statusBar, statusLabel);
                } else {
                    //详见复制文件类
                    copyFile(mainDirTmp, copyToDirPath, fileUtils, statusBar, statusLabel);
                }
            } else {
